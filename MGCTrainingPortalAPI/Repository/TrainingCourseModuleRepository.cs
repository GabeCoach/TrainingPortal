...
namespace MGCTrainingPortalAPI.Repository
{
    public class TrainingCourseModuleRepository: IRepository<TrainingCourseModule>
    {
        ...
        public IQueryable<TrainingCourseModule> SelectAllFromDB()
        {
            ...
            {
                oLogger.LogData("METHOD: SelectAllFromDB; REPO: TrainingCourseModule; EXCEPTION: " + ex.Message + "; INNER EXCEPTION: " + ex.InnerException + "; STACKTRACE: " + ex.StackTrace);
        ...
        public async Task<TrainingCourseModule> SelectById(int iCourseId)
        {
            ...
            {
                oLogger.LogData("METHOD: SelectById; REPO: TrainingCourseModule; EXCEPTION: " + ex.Message + "; INNER EXCEPTION: " + ex.InnerException + "; STACKTRACE: " + ex.StackTrace);
                throw new Exception(ex.Message);
            }
        }
        ...
        public async Task<TrainingCourseModule> SaveToDB(TrainingCourseModule oTrainingCourseModule)
        {
            ...
            {
                oLogger.LogData("METHOD: SaveToDB; REPO: TrainingCourseModule; EXCEPTION: " + ex.Message + "; INNER EXCEPTION: " + ex.InnerException + "; STACKTRACE: " + ex.StackTrace);
                throw new Exception(ex.Message);
            }
        }
        ...
        public async Task<TrainingCourseModule> UpdateToDB(TrainingCourseModule oTrainingCourseModule, int iModuleId)
        {
            ...
            {
                oLogger.LogData("METHOD: UpdateToDB; REPO: TrainingCourseModule; EXCEPTION: " + ex.Message + "; INNER EXCEPTION: " + ex.InnerException + "; STACKTRACE: " + ex.StackTrace);
                throw new Exception(ex.Message);
            }
        }
        ...
        public async Task<TrainingCourseModule> DeleteFromDB(int iModuleId)
        {
            ...
            {
                oLogger.LogData("METHOD: DeleteFromDB; REPO: TrainingCourseModule; EXCEPTION: " + ex.Message + "; INNER EXCEPTION: " + ex.InnerException + "; STACKTRACE: " + ex.StackTrace);
                throw new Exception(ex.Message);
            }
